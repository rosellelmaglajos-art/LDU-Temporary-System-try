        ...
        {showInfo ? (
          <div className="flex flex-col justify-center flex-1 p-8 md:p-12 lg:p-14 bg-white animate-in fade-in slide-in-from-right-8 duration-500">
            ...
            <div className="space-y-4">
              {['IPAR', 'PNPKI Application', 'CyberSecurity Response', 'ISSP'].map((service, i) => (
                <div key={i} className="flex items-start gap-5 p-5 border border-slate-200 hover:border-blue-500 hover:shadow-md rounded-2xl transition-all group cursor-pointer">
